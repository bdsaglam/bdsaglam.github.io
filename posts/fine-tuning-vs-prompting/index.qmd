...
- For tasks involving complex or subjective evaluation criteria, prompt optimization shows stronger performance, as evidenced by the ELO ratings in our entity-relation extraction experiments.
...
To promote reproducibility and further research in this area, we have open-sourced our experimental implementation and analysis code at [this GitHub repository](https://github.com/bdsaglam/pipeline-llm-adaptation).
...
7. [Zheng, L., Chiang, W., Sheng, Y., Zhuang, S., Wu, Z., Zhuang, Y., Lin, Z., Li, Z., Li, D., Xing, E.P., Zhang, H., Gonzalez, J.E., & Stoica, I. (2023). Judging LLM-as-a-judge with MT-Bench and Chatbot Arena. ArXiv, abs/2306.05685.](https://arxiv.org/abs/2306.05685)
