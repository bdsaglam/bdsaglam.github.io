...
3. **Pairwise Comparisons:** [Qwen-2.5-32B](https://huggingface.co/Qwen/Qwen2.5-32B-Instruct) was employed as a judge to directly compare outputs from different models. For each test example, the judge was presented with:
   - The input text
