import{_ as c,a as m,b as g,c as p}from"./modules/unplugin-icons-CcJ6vSwS.js";import{o as h,b as f,w as y,g as e,j as _,D as n,d as i,v as w,x as b,z as o}from"./modules/vue-tOaAuCXo.js";import{I as v}from"./slidev/default-BcyEqOWa.js";import{u as k,f as x}from"./slidev/context-Dif9tfZK.js";import"./index-MkpE3lwf.js";import"./modules/shiki-6pP-d7XW.js";const A="/slides/sdft/images/s11-linkedin-qr.png",T={class:"grid grid-cols-[1fr_auto] gap-6 text-xs"},D={class:"flex flex-col items-center gap-2"},I={class:"flex gap-3 items-center text-lg"},E={__name:"11-closing.md__slidev_40",setup(O){const{$clicksContext:s,$frontmatter:a}=k();return s.setup(),(S,t)=>{const l=c,r=m,u=g,d=p;return h(),f(v,w(b(o(x)(o(a),39))),{default:y(()=>[t[3]||(t[3]=e("h1",null,"Q&A",-1)),_(`
SPEAKING:
