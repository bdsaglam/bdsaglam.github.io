...
- Same shape both sides — the only edit is $\exp(\cdot)\to\mathrm{sim}(\cdot)$. The normalizer is one scalar per query, so it sits in the denominator rather than inside each weight.
