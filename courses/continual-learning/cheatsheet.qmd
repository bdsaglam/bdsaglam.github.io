...
[M7](foundations/m7-three-dials.ipynb) derives the recurrence from M3, states every foundations module as a dial setting, runs the dial board, and extends the zoo to models the course does not otherwise cover. This section is the one-line summary; M7 is where it is built.
